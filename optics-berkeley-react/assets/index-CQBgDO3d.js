 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(C,k){var F=C.length;C.push(k);e:for(;0<F;){var G=F-1>>>1,Z=C[G];if(0<i(Z,k))C[G]=k,C[F]=Z,F=G;else break e}}function n(C){return C.length===0?null:C[0]}function a(C){if(C.length===0)return null;var k=C[0],F=C.pop();if(F!==k){C[0]=F;e:for(var G=0,Z=C.length,ua=Z>>>1;G<ua;){var St=2*(G+1)-1,zi=C[St],vt=St+1,fa=C[vt];if(0>i(zi,F))vt<Z&&0>i(fa,zi)?(C[G]=fa,C[vt]=F,G=vt):(C[G]=zi,C[St]=F,G=St);else if(vt<Z&&0>i(fa,F))C[G]=fa,C[vt]=F,G=vt;else break e}}return k}function i(C,k){var F=C.sortIndex-k.sortIndex;return F!==0?F:C.id-k.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var o=Date,r=o.now();e.unstable_now=function(){return o.now()-r}}var s=[],p=[],m=1,c=null,h=3,y=!1,T=!1,b=!1,x=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,u=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function d(C){for(var k=n(p);k!==null;){if(k.callback===null)a(p);else if(k.startTime<=C)a(p),k.sortIndex=k.expirationTime,t(s,k);else break;k=n(p)}}function g(C){if(b=!1,d(C),!T)if(n(s)!==null)T=!0,Fi(v);else{var k=n(p);k!==null&&Ri(g,k.startTime-C)}}function v(C,k){T=!1,b&&(b=!1,f(w),w=-1),y=!0;var F=h;try{for(d(k),c=n(s);c!==null&&(!(c.expirationTime>k)||C&&!Ne());){var G=c.callback;if(typeof G=="function"){c.callback=null,h=c.priorityLevel;var Z=G(c.expirationTime<=k);k=e.unstable_now(),typeof Z=="function"?c.callback=Z:c===n(s)&&a(s),d(k)}else a(s);c=n(s)}if(c!==null)var ua=!0;else{var St=n(p);St!==null&&Ri(g,St.startTime-k),ua=!1}return ua}finally{c=null,h=F,y=!1}}var P=!1,N=null,w=-1,W=5,z=-1;function Ne(){return!(e.unstable_now()-z<W)}function hn(){if(N!==null){var C=e.unstable_now();z=C;var k=!0;try{k=N(!0,C)}finally{k?gn():(P=!1,N=null)}}else P=!1}var gn;if(typeof u=="function")gn=function(){u(hn)};else if(typeof MessageChannel<"u"){var ar=new MessageChannel,Gu=ar.port2;ar.port1.onmessage=hn,gn=function(){Gu.postMessage(null)}}else gn=function(){x(hn,0)};function Fi(C){N=C,P||(P=!0,gn())}function Ri(C,k){w=x(function(){C(e.unstable_now())},k)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(C){C.callback=null},e.unstable_continueExecution=function(){T||y||(T=!0,Fi(v))},e.unstable_forceFrameRate=function(C){0>C||125<C?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):W=0<C?Math.floor(1e3/C):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(C){switch(h){case 1:case 2:case 3:var k=3;break;default:k=h}var F=h;h=k;try{return C()}finally{h=F}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(C,k){switch(C){case 1:case 2:case 3:case 4:case 5:break;default:C=3}var F=h;h=C;try{return k()}finally{h=F}},e.unstable_scheduleCallback=function(C,k,F){var G=e.unstable_now();switch(typeof F=="object"&&F!==null?(F=F.delay,F=typeof F=="number"&&0<F?G+F:G):F=G,C){case 1:var Z=-1;break;case 2:Z=250;break;case 5:Z=1073741823;break;case 4:Z=1e4;break;default:Z=5e3}return Z=F+Z,C={id:m++,callback:k,priorityLevel:C,startTime:F,expirationTime:Z,sortIndex:-1},F>G?(C.sortIndex=F,t(p,C),n(s)===null&&C===n(p)&&(b?(f(w),w=-1):b=!0,Ri(g,F-G))):(C.sortIndex=Z,t(s,C),T||y||(T=!0,Fi(v))),C},e.unstable_shouldYield=Ne,e.unstable_wrapCallback=function(C){var k=h;return function(){var F=h;h=k;try{return C.apply(this,arguments)}finally{h=F}}}})(As);Ds.exports=As;var xf=Ds.exports;/**
 * @license React
 ...
 *
 * @license MIT
 */function na(){return na=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var a in n)Object.prototype.hasOwnProperty.call(n,a)&&(e[a]=n[a])}return e},na.apply(this,arguments)}var lt;(function(e){e.Pop="POP",e.Push="PUSH",e.Replace="REPLACE"})(lt||(lt={}));const cs="popstate";function vc(e){e===void 0&&(e={});function t(i,l){let{pathname:o="/",search:r="",hash:s=""}=_t(i.location.hash.substr(1));return!o.startsWith("/")&&!o.startsWith(".")&&(o="/"+o),eo("",{pathname:o,search:r,hash:s},l.state&&l.state.usr||null,l.state&&l.state.key||"default")}function n(i,l){let o=i.document.querySelector("base"),r="";if(o&&o.getAttribute("href")){let s=i.location.href,p=s.indexOf("#");r=p===-1?s:s.slice(0,p)}return r+"#"+(typeof l=="string"?l:di(l))}function a(i,l){wi(i.pathname.charAt(0)==="/","relative pathnames are not supported in hash history.push("+JSON.stringify(l)+")")}return Lc(t,n,a,e)}function K(e,t){if(e===!1||e===null||typeof e>"u")throw new Error(t)}function wi(e,t){if(!e){typeof console<"u"&&console.warn(t);try{throw new Error(t)}catch{}}}function Ic(){return Math.random().toString(36).substr(2,8)}function ms(e,t){return{usr:e.state,key:e.key,idx:t}}function eo(e,t,n,a){return n===void 0&&(n=null),na({pathname:typeof e=="string"?e:e.pathname,search:"",hash:""},typeof t=="string"?_t(t):t,{state:n,key:t&&t.key||a||Ic()})}function di(e){let{pathname:t="/",search:n="",hash:a=""}=e;return n&&n!=="?"&&(t+=n.charAt(0)==="?"?n:"?"+n),a&&a!=="#"&&(t+=a.charAt(0)==="#"?a:"#"+a),t}function _t(e){let t={};if(e){let n=e.indexOf("#");n>=0&&(t.hash=e.substr(n),e=e.substr(0,n));let a=e.indexOf("?");a>=0&&(t.search=e.substr(a),e=e.substr(0,a)),e&&(t.pathname=e)}return t}function Lc(e,t,n,a){a===void 0&&(a={});let{window:i=document.defaultView,v5Compat:l=!1}=a,o=i.history,r=lt.Pop,s=null,p=m();p==null&&(p=0,o.replaceState(na({},o.state,{idx:p}),""));function m(){return(o.state||{idx:null}).idx}function c(){r=lt.Pop;let x=m(),f=x==null?null:x-p;p=x,s&&s({action:r,location:b.location,delta:f})}function h(x,f){r=lt.Push;let u=eo(b.location,x,f);n&&n(u,x),p=m()+1;let d=ms(u,p),g=b.createHref(u);try{o.pushState(d,"",g)}catch(v){if(v instanceof DOMException&&v.name==="DataCloneError")throw v;i.location.assign(g)}l&&s&&s({action:r,location:b.location,delta:1})}function y(x,f){r=lt.Replace;let u=eo(b.location,x,f);n&&n(u,x),p=m();let d=ms(u,p),g=b.createHref(u);o.replaceState(d,"",g),l&&s&&s({action:r,location:b.location,delta:0})}function T(x){let f=i.location.origin!=="null"?i.location.origin:i.location.href,u=typeof x=="string"?x:di(x);return u=u.replace(/ $/,"%20"),K(f,"No window.location.(origin|href) available to create URL for href: "+u),new URL(u,f)}let b={get action(){return r},get location(){return e(i,o)},listen(x){if(s)throw new Error("A history only accepts one active listener");return i.addEventListener(cs,c),s=x,()=>{i.removeEventListener(cs,c),s=null}},createHref(x){return t(i,x)},createURL:T,encodeLocation(x){let f=T(x);return{pathname:f.pathname,search:f.search,hash:f.hash}},push:h,replace:y,go(x){return o.go(x)}};return b}var hs;(function(e){e.data="data",e.deferred="deferred",e.redirect="redirect",e.error="error"})(hs||(hs={}));function Oc(e,t,n){return n===void 0&&(n="/"),Pc(e,t,n)}function Pc(e,t,n,a){let i=typeof t=="string"?_t(t):t,l=Jo(i.pathname||"/",n);if(l==null)return null;let o=Du(e);Cc(o);let r=null;for(let s=0;r==null&&s<o.length;++s){let p=Yc(l);r=Ac(o[s],p)}return r}function Du(e,t,n,a){t===void 0&&(t=[]),n===void 0&&(n=[]),a===void 0&&(a="");let i=(l,o,r)=>{let s={relativePath:r===void 0?l.path||"":r,caseSensitive:l.caseSensitive===!0,childrenIndex:o,route:l};s.relativePath.startsWith("/")&&(K(s.relativePath.startsWith(a),'Absolute route path "'+s.relativePath+'" nested under path '+('"'+a+'" is not valid. An absolute child route path ')+"must start with the combined path of all its parent routes."),s.relativePath=s.relativePath.slice(a.length));let p=mt([a,s.relativePath]),m=n.concat(s);l.children&&l.children.length>0&&(K(l.index!==!0,"Index routes must not have child routes. Please remove "+('all child routes from route path "'+p+'".')),Du(l.children,t,m,p)),!(l.path==null&&!l.index)&&t.push({path:p,score:Mc(p,l.index),routesMeta:m})};return e.forEach((l,o)=>{var r;if(l.path===""||!((r=l.path)!=null&&r.includes("?")))i(l,o);else for(let s of Au(l.path))i(l,o,s)}),t}function Au(e){let t=e.split("/");if(t.length===0)return[];let[n,...a]=t,i=n.endsWith("?"),l=n.replace(/\?$/,"");if(a.length===0)return i?[l,""]:[l];let o=Au(a.join("/")),r=[];return r.push(...o.map(s=>s===""?l:[l,s].join("/"))),i&&r.push(...o),r.map(s=>e.startsWith("/")&&s===""?"/":s)}function Cc(e){e.sort((t,n)=>t.score!==n.score?n.score-t.score:Dc(t.routesMeta.map(a=>a.childrenIndex),n.routesMeta.map(a=>a.childrenIndex)))}const Nc=/^:[\w-]+$/,wc=3,kc=2,Fc=1,Rc=10,zc=-2,gs=e=>e==="*";function Mc(e,t){let n=e.split("/"),a=n.length;return n.some(gs)&&(a+=zc),t&&(a+=kc),n.filter(i=>!gs(i)).reduce((i,l)=>i+(Nc.test(l)?wc:l===""?Fc:Rc),a)}function Dc(e,t){return e.length===t.length&&e.slice(0,-1).every((a,i)=>a===t[i])?e[e.length-1]-t[t.length-1]:0}function Ac(e,t,n){let{routesMeta:a}=e,i={},l="/",o=[];for(let r=0;r<a.length;++r){let s=a[r],p=r===a.length-1,m=l==="/"?t:t.slice(l.length)||"/",c=_c({path:s.relativePath,caseSensitive:s.caseSensitive,end:p},m),h=s.route;if(!c)return null;Object.assign(i,c.params),o.push({params:i,pathname:mt([l,c.pathname]),pathnameBase:Wc(mt([l,c.pathnameBase])),route:h}),c.pathnameBase!=="/"&&(l=mt([l,c.pathnameBase]))}return o}function _c(e,t){typeof e=="string"&&(e={path:e,caseSensitive:!1,end:!0});let[n,a]=Ec(e.path,e.caseSensitive,e.end),i=t.match(n);if(!i)return null;let l=i[0],o=l.replace(/(.)\/+$/,"$1"),r=i.slice(1);return{params:a.reduce((p,m,c)=>{let{paramName:h,isOptional:y}=m;if(h==="*"){let b=r[c]||"";o=l.slice(0,l.length-b.length).replace(/(.)\/+$/,"$1")}const T=r[c];return y&&!T?p[h]=void 0:p[h]=(T||"").replace(/%2F/g,"/"),p},{}),pathname:l,pathnameBase:o,pattern:e}}function Ec(e,t,n){t===void 0&&(t=!1),n===void 0&&(n=!0),wi(e==="*"||!e.endsWith("*")||e.endsWith("/*"),'Route path "'+e+'" will be treated as if it were '+('"'+e.replace(/\*$/,"/*")+'" because the `*` character must ')+"always follow a `/` in the pattern. To get rid of this warning, "+('please change the route path to "'+e.replace(/\*$/,"/*")+'".'));let a=[],i="^"+e.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(o,r,s)=>(a.push({paramName:r,isOptional:s!=null}),s?"/?([^\\/]+)?":"/([^\\/]+)"));return e.endsWith("*")?(a.push({paramName:"*"}),i+=e==="*"||e==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):n?i+="\\/*$":e!==""&&e!=="/"&&(i+="(?:(?=\\/|$))"),[new RegExp(i,t?void 0:"i"),a]}function Yc(e){try{return e.split("/").map(t=>decodeURIComponent(t).replace(/\//g,"%2F")).join("/")}catch(t){return wi(!1,'The URL path "'+e+'" could not be decoded because it is is a malformed URL segment. This is probably due to a bad percent '+("encoding ("+t+").")),e}}function Jo(e,t){if(t==="/")return e;if(!e.toLowerCase().startsWith(t.toLowerCase()))return null;let n=t.endsWith("/")?t.length-1:t.length,a=e.charAt(n);return a&&a!=="/"?null:e.slice(n)||"/"}const qc=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,jc=e=>qc.test(e);function Bc(e,t){t===void 0&&(t="/");let{pathname:n,search:a="",hash:i=""}=typeof e=="string"?_t(e):e,l;if(n)if(jc(n))l=n;else{if(n.includes("//")){let o=n;n=n.replace(/\/\/+/g,"/"),wi(!1,"Pathnames cannot have embedded double slashes - normalizing "+(o+" -> "+n))}n.startsWith("/")?l=xs(n.substring(1),"/"):l=xs(n,t)}else l=t;return{pathname:l,search:Gc(a),hash:Hc(i)}}function xs(e,t){let n=t.replace(/\/+$/,"").split("/");return e.split("/").forEach(i=>{i===".."?n.length>1&&n.pop():i!=="."&&n.push(i)}),n.length>1?n.join("/"):"/"}function ol(e,t,n,a){return"Cannot include a '"+e+"' character in a manually specified "+("`to."+t+"` field ["+JSON.stringify(a)+"].  Please separate it out to the ")+("`to."+n+"` field. Alternatively you may provide the full path as ")+'a string in <Link to="..."> and the router will parse it for you.'}function Xc(e){return e.filter((t,n)=>n===0||t.route.path&&t.route.path.length>0)}function er(e,t){let n=Xc(e);return t?n.map((a,i)=>i===n.length-1?a.pathname:a.pathnameBase):n.map(a=>a.pathnameBase)}function tr(e,t,n,a){a===void 0&&(a=!1);let i;typeof e=="string"?i=_t(e):(i=na({},e),K(!i.pathname||!i.pathname.includes("?"),ol("?","pathname","search",i)),K(!i.pathname||!i.pathname.includes("#"),ol("#","pathname","hash",i)),K(!i.search||!i.search.includes("#"),ol("#","search","hash",i)));let l=e===""||i.pathname==="",o=l?"/":i.pathname,r;if(o==null)r=n;else{let c=t.length-1;if(!a&&o.startsWith("..")){let h=o.split("/");for(;h[0]==="..";)h.shift(),c-=1;i.pathname=h.join("/")}r=c>=0?t[c]:"/"}let s=Bc(i,r),p=o&&o!=="/"&&o.endsWith("/"),m=(l||o===".")&&n.endsWith("/");return!s.pathname.endsWith("/")&&(p||m)&&(s.pathname+="/"),s}const mt=e=>e.join("/").replace(/\/\/+/g,"/"),Wc=e=>e.replace(/\/+$/,"").replace(/^\/*/,"/"),Gc=e=>!e||e==="?"?"":e.startsWith("?")?e:"?"+e,Hc=e=>!e||e==="#"?"":e.startsWith("#")?e:"#"+e;function Kc(e){return e!=null&&typeof e.status=="number"&&typeof e.statusText=="string"&&typeof e.internal=="boolean"&&"data"in e}const _u=["post","put","patch","delete"];new Set(_u);const Uc=["get",..._u];new Set(Uc);/**
 ...
 *
 * @license MIT
 */function aa(){return aa=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var a in n)Object.prototype.hasOwnProperty.call(n,a)&&(e[a]=n[a])}return e},aa.apply(this,arguments)}const nr=I.createContext(null),Vc=I.createContext(null),Tt=I.createContext(null),ki=I.createContext(null),Ze=I.createContext({outlet:null,matches:[],isDataRoute:!1}),Eu=I.createContext(null);function $c(e,t){let{relative:n}=t===void 0?{}:t;mn()||K(!1);let{basename:a,navigator:i}=I.useContext(Tt),{hash:l,pathname:o,search:r}=ju(e,{relative:n}),s=o;return a!=="/"&&(s=o==="/"?a:mt([a,o])),i.createHref({pathname:s,search:r,hash:l})}function mn(){return I.useContext(ki)!=null}function pa(){return mn()||K(!1),I.useContext(ki).location}function Yu(e){I.useContext(Tt).static||I.useLayoutEffect(e)}function qu(){let{isDataRoute:e}=I.useContext(Ze);return e?u1():Zc()}function Zc(){mn()||K(!1);let e=I.useContext(nr),{basename:t,future:n,navigator:a}=I.useContext(Tt),{matches:i}=I.useContext(Ze),{pathname:l}=pa(),o=JSON.stringify(er(i,n.v7_relativeSplatPath)),r=I.useRef(!1);return Yu(()=>{r.current=!0}),I.useCallback(function(p,m){if(m===void 0&&(m={}),!r.current)return;if(typeof p=="number"){a.go(p);return}let c=tr(p,JSON.parse(o),l,m.relative==="path");e==null&&t!=="/"&&(c.pathname=c.pathname==="/"?t:mt([t,c.pathname])),(m.replace?a.replace:a.push)(c,m.state,m)},[t,a,o,l,e])}function Qc(){let{matches:e}=I.useContext(Ze),t=e[e.length-1];return t?t.params:{}}function ju(e,t){let{relative:n}=t===void 0?{}:t,{future:a}=I.useContext(Tt),{matches:i}=I.useContext(Ze),{pathname:l}=pa(),o=JSON.stringify(er(i,a.v7_relativeSplatPath));return I.useMemo(()=>tr(e,JSON.parse(o),l,n==="path"),[e,o,l,n])}function Jc(e,t){return e1(e,t)}function e1(e,t,n,a){mn()||K(!1);let{navigator:i}=I.useContext(Tt),{matches:l}=I.useContext(Ze),o=l[l.length-1],r=o?o.params:{};o&&o.pathname;let s=o?o.pathnameBase:"/";o&&o.route;let p=pa(),m;if(t){var c;let x=typeof t=="string"?_t(t):t;s==="/"||(c=x.pathname)!=null&&c.startsWith(s)||K(!1),m=x}else m=p;let h=m.pathname||"/",y=h;if(s!=="/"){let x=s.replace(/^\//,"").split("/");y="/"+h.replace(/^\//,"").split("/").slice(x.length).join("/")}let T=Oc(e,{pathname:y}),b=l1(T&&T.map(x=>Object.assign({},x,{params:Object.assign({},r,x.params),pathname:mt([s,i.encodeLocation?i.encodeLocation(x.pathname).pathname:x.pathname]),pathnameBase:x.pathnameBase==="/"?s:mt([s,i.encodeLocation?i.encodeLocation(x.pathnameBase).pathname:x.pathnameBase])})),l,n,a);return t&&b?I.createElement(ki.Provider,{value:{location:aa({pathname:"/",search:"",hash:"",state:null,key:"default"},m),navigationType:lt.Pop}},b):b}function t1(){let e=p1(),t=Kc(e)?e.status+" "+e.statusText:e instanceof Error?e.message:JSON.stringify(e),n=e instanceof Error?e.stack:null,i={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return I.createElement(I.Fragment,null,I.createElement("h2",null,"Unexpected Application Error!"),I.createElement("h3",{style:{fontStyle:"italic"}},t),n?I.createElement("pre",{style:i},n):null,null)}const n1=I.createElement(t1,null);class a1 extends I.Component{constructor(t){super(t),this.state={location:t.location,revalidation:t.revalidation,error:t.error}}static getDerivedStateFromError(t){return{error:t}}static getDerivedStateFromProps(t,n){return n.location!==t.location||n.revalidation!=="idle"&&t.revalidation==="idle"?{error:t.error,location:t.location,revalidation:t.revalidation}:{error:t.error!==void 0?t.error:n.error,location:n.location,revalidation:t.revalidation||n.revalidation}}componentDidCatch(t,n){console.error("React Router caught the following error during render",t,n)}render(){return this.state.error!==void 0?I.createElement(Ze.Provider,{value:this.props.routeContext},I.createElement(Eu.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function i1(e){let{routeContext:t,match:n,children:a}=e,i=I.useContext(nr);return i&&i.static&&i.staticContext&&(n.route.errorElement||n.route.ErrorBoundary)&&(i.staticContext._deepestRenderedBoundaryId=n.route.id),I.createElement(Ze.Provider,{value:t},a)}function l1(e,t,n,a){var i;if(t===void 0&&(t=[]),n===void 0&&(n=null),a===void 0&&(a=null),e==null){var l;if(!n)return null;if(n.errors)e=n.matches;else if((l=a)!=null&&l.v7_partialHydration&&t.length===0&&!n.initialized&&n.matches.length>0)e=n.matches;else return null}let o=e,r=(i=n)==null?void 0:i.errors;if(r!=null){let m=o.findIndex(c=>c.route.id&&(r==null?void 0:r[c.route.id])!==void 0);m>=0||K(!1),o=o.slice(0,Math.min(o.length,m+1))}let s=!1,p=-1;if(n&&a&&a.v7_partialHydration)for(let m=0;m<o.length;m++){let c=o[m];if((c.route.HydrateFallback||c.route.hydrateFallbackElement)&&(p=m),c.route.id){let{loaderData:h,errors:y}=n,T=c.route.loader&&h[c.route.id]===void 0&&(!y||y[c.route.id]===void 0);if(c.route.lazy||T){s=!0,p>=0?o=o.slice(0,p+1):o=[o[0]];break}}}return o.reduceRight((m,c,h)=>{let y,T=!1,b=null,x=null;n&&(y=r&&c.route.id?r[c.route.id]:void 0,b=c.route.errorElement||n1,s&&(p<0&&h===0?(f1("route-fallback"),T=!0,x=null):p===h&&(T=!0,x=c.route.hydrateFallbackElement||null)));let f=t.concat(o.slice(0,h+1)),u=()=>{let d;return y?d=b:T?d=x:c.route.Component?d=I.createElement(c.route.Component,null):c.route.element?d=c.route.element:d=m,I.createElement(i1,{match:c,routeContext:{outlet:m,matches:f,isDataRoute:n!=null},children:d})};return n&&(c.route.ErrorBoundary||c.route.errorElement||h===0)?I.createElement(a1,{location:n.location,revalidation:n.revalidation,component:b,error:y,children:u(),routeContext:{outlet:null,matches:f,isDataRoute:!0}}):u()},null)}var Bu=function(e){return e.UseBlocker="useBlocker",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e}(Bu||{}),Xu=function(e){return e.UseBlocker="useBlocker",e.UseLoaderData="useLoaderData",e.UseActionData="useActionData",e.UseRouteError="useRouteError",e.UseNavigation="useNavigation",e.UseRouteLoaderData="useRouteLoaderData",e.UseMatches="useMatches",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e.UseRouteId="useRouteId",e}(Xu||{});function o1(e){let t=I.useContext(nr);return t||K(!1),t}function r1(e){let t=I.useContext(Vc);return t||K(!1),t}function s1(e){let t=I.useContext(Ze);return t||K(!1),t}function Wu(e){let t=s1(),n=t.matches[t.matches.length-1];return n.route.id||K(!1),n.route.id}function p1(){var e;let t=I.useContext(Eu),n=r1(),a=Wu();return t!==void 0?t:(e=n.errors)==null?void 0:e[a]}function u1(){let{router:e}=o1(Bu.UseNavigateStable),t=Wu(Xu.UseNavigateStable),n=I.useRef(!1);return Yu(()=>{n.current=!0}),I.useCallback(function(i,l){l===void 0&&(l={}),n.current&&(typeof i=="number"?e.navigate(i):e.navigate(i,aa({fromRouteId:t},l)))},[e,t])}const ys={};function f1(e,t,n){ys[e]||(ys[e]=!0)}function d1(e,t){e==null||e.v7_startTransition,e==null||e.v7_relativeSplatPath}function c1(e){let{to:t,replace:n,state:a,relative:i}=e;mn()||K(!1);let{future:l,static:o}=I.useContext(Tt),{matches:r}=I.useContext(Ze),{pathname:s}=pa(),p=qu(),m=tr(t,er(r,l.v7_relativeSplatPath),s,i==="path"),c=JSON.stringify(m);return I.useEffect(()=>p(JSON.parse(c),{replace:n,state:a,relative:i}),[p,c,i,n,a]),null}function ja(e){K(!1)}function m1(e){let{basename:t="/",children:n=null,location:a,navigationType:i=lt.Pop,navigator:l,static:o=!1,future:r}=e;mn()&&K(!1);let s=t.replace(/^\/*/,"/"),p=I.useMemo(()=>({basename:s,navigator:l,static:o,future:aa({v7_relativeSplatPath:!1},r)}),[s,r,l,o]);typeof a=="string"&&(a=_t(a));let{pathname:m="/",search:c="",hash:h="",state:y=null,key:T="default"}=a,b=I.useMemo(()=>{let x=Jo(m,s);return x==null?null:{location:{pathname:x,search:c,hash:h,state:y,key:T},navigationType:i}},[s,m,c,h,y,T,i]);return b==null?null:I.createElement(Tt.Provider,{value:p},I.createElement(ki.Provider,{children:n,value:b}))}function h1(e){let{children:t,location:n}=e;return Jc(to(t),n)}new Promise(()=>{});function to(e,t){t===void 0&&(t=[]);let n=[];return I.Children.forEach(e,(a,i)=>{if(!I.isValidElement(a))return;let l=[...t,i];if(a.type===I.Fragment){n.push.apply(n,to(a.props.children,l));return}a.type!==ja&&K(!1),!a.props.index||!a.props.children||K(!1);let o={id:a.props.id||l.join("-"),caseSensitive:a.props.caseSensitive,element:a.props.element,Component:a.props.Component,index:a.props.index,path:a.props.path,loader:a.props.loader,action:a.props.action,errorElement:a.props.errorElement,ErrorBoundary:a.props.ErrorBoundary,hasErrorBoundary:a.props.ErrorBoundary!=null||a.props.errorElement!=null,shouldRevalidate:a.props.shouldRevalidate,handle:a.props.handle,lazy:a.props.lazy};a.props.children&&(o.children=to(a.props.children,l)),n.push(o)}),n}/**
 ...
 *
 * @license MIT
 */function no(){return no=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var a in n)Object.prototype.hasOwnProperty.call(n,a)&&(e[a]=n[a])}return e},no.apply(this,arguments)}function g1(e,t){if(e==null)return{};var n={},a=Object.keys(e),i,l;for(l=0;l<a.length;l++)i=a[l],!(t.indexOf(i)>=0)&&(n[i]=e[i]);return n}function x1(e){return!!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)}function y1(e,t){return e.button===0&&(!t||t==="_self")&&!x1(e)}const b1=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","viewTransition"],T1="6";try{window.__reactRouterVersion=T1}catch{}const S1="startTransition",bs=uf[S1];function v1(e){let{basename:t,children:n,future:a,window:i}=e,l=I.useRef();l.current==null&&(l.current=vc({window:i,v5Compat:!0}));let o=l.current,[r,s]=I.useState({action:o.action,location:o.location}),{v7_startTransition:p}=a||{},m=I.useCallback(c=>{p&&bs?bs(()=>s(c)):s(c)},[s,p]);return I.useLayoutEffect(()=>o.listen(m),[o,m]),I.useEffect(()=>d1(a),[a]),I.createElement(m1,{basename:t,children:n,location:r.location,navigationType:r.action,navigator:o,future:a})}const I1=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",L1=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,ao=I.forwardRef(function(t,n){let{onClick:a,relative:i,reloadDocument:l,replace:o,state:r,target:s,to:p,preventScrollReset:m,viewTransition:c}=t,h=g1(t,b1),{basename:y}=I.useContext(Tt),T,b=!1;if(typeof p=="string"&&L1.test(p)&&(T=p,I1))try{let d=new URL(window.location.href),g=p.startsWith("//")?new URL(d.protocol+p):new URL(p),v=Jo(g.pathname,y);g.origin===d.origin&&v!=null?p=v+g.search+g.hash:b=!0}catch{}let x=$c(p,{relative:i}),f=O1(p,{replace:o,state:r,target:s,preventScrollReset:m,relative:i,viewTransition:c});function u(d){a&&a(d),d.defaultPrevented||f(d)}return I.createElement("a",no({},h,{href:T||x,onClick:b||l?a:u,ref:n,target:s}))});var Ts;(function(e){e.UseScrollRestoration="useScrollRestoration",e.UseSubmit="useSubmit",e.UseSubmitFetcher="useSubmitFetcher",e.UseFetcher="useFetcher",e.useViewTransitionState="useViewTransitionState"})(Ts||(Ts={}));var Ss;(function(e){e.UseFetcher="useFetcher",e.UseFetchers="useFetchers",e.UseScrollRestoration="useScrollRestoration"})(Ss||(Ss={}));function O1(e,t){let{target:n,replace:a,state:i,preventScrollReset:l,relative:o,viewTransition:r}=t===void 0?{}:t,s=qu(),p=pa(),m=ju(e,{relative:o});return I.useCallback(c=>{if(y1(c,n)){c.preventDefault();let h=a!==void 0?a:di(p)===di(m);s(e,{replace:h,state:i,preventScrollReset:l,relative:o,viewTransition:r})}},[p,s,m,a,i,n,e,l,o,r])}const wn=[{id:"of",title:"of - G10TINPOS\r",description:"G10TINPOS\r",category:"Optics - Geometrical",chapter:"1",source:"matlab",pythonCode:`import matplotlib.pyplot as plt
import numpy as np
import io
import base64
...
`,cCode:"",defaultParams:{}}];function P1(){const e={};return wn.forEach(t=>{const n=t.category||"其他";e[n]||(e[n]=[]),e[n].push(t)}),L.jsxs("div",{className:"program-list",children:[L.jsxs("div",{className:"header",children:[L.jsx("h1",{children:"🔬 Optics & Berkeley Extension 程序集"}),L.jsxs("p",{className:"subtitle",children:["包含 ",wn.length," 个程序：",wn.filter(t=>t.source==="matlab").length," 个 MATLAB 程序和 ",wn.filter(t=>t.source==="c").length," 个 C 程序"]})]}),L.jsx("div",{className:"categories",children:Object.keys(e).sort().map(t=>L.jsxs("div",{className:"category-section",children:[L.jsx("h2",{children:t}),L.jsx("div",{className:"program-grid",children:e[t].map(n=>L.jsxs(ao,{to:`/program/${n.id}`,className:"program-card",children:[L.jsx("div",{className:"program-title",children:n.title}),L.jsx("div",{className:"program-description",children:n.description}),L.jsxs("div",{className:"program-meta",children:[L.jsx("span",{className:"program-source",children:n.source.toUpperCase()}),n.chapter&&L.jsxs("span",{className:"program-chapter",children:["Ch-",n.chapter]})]})]},n.id))})]},t))})]})}function C1({imageData:e}){return L.jsxs("div",{className:"plot-container",children:[L.jsx("h3",{children:"图表输出"}),L.jsx("img",{src:`data:image/png;base64,${e}`,alt:"Plot"})]})}function N1({text:e}){const t=e.startsWith("❌");return L.jsx("div",{className:`text-output ${t?"error":""}`,children:e})}function w1({pyodide:e,program:t}){const[n,a]=I.useState("python"),[i,l]=I.useState(t.pythonCode||""),[o,r]=I.useState(!1),[s,p]=I.useState(null),[m,c]=I.useState(""),[h,y]=I.useState(t.defaultParams||{});I.useEffect(()=>{l(t.pythonCode||""),y(t.defaultParams||{}),p(null),c("")},[t]);async function T(){if(!(!e||o)){r(!0),p(null),c("⏳ Running...");try{let x=i;Object.keys(h).forEach(P=>{const N=h[P];typeof N=="string"?x=x.replace(new RegExp(`\\{\\{${P}\\}\\}`,"g"),`"${N}"`):x=x.replace(new RegExp(`\\{\\{${P}\\}\\}`,"g"),N)});const f=`
...
`;await e.runPythonAsync(f);const u=e.globals.get("out"),d=e.globals.get("err");let g=null,v=u||"";if(v&&v.includes("data:image/png;base64,")){const P=v.match(/data:image\/png;base64,([A-Za-z0-9+/=]+)/);P&&(g=P[1],v=v.replace(/data:image\/png;base64,[A-Za-z0-9+/=]+/,"").trim())}g&&p(g),c(d?`❌ Error:
`+d+(v?`

Output:
`+v:""):v||(g?"":"✅ Program executed successfully"))}catch(x){c(`❌ Error:
`+(x&&x.message?x.message:String(x))),console.error("Error:",x)}finally{r(!1)}}}if(!e)return L.jsx("div",{className:"ide-layout",children:L.jsx("div",{className:"loading-container",children:L.jsx("div",{className:"loading",children:"⏳ Loading Python environment..."})})});const b=[];return t.matlabCode&&b.push({id:"matlab",label:"MATLAB"}),b.push({id:"python",label:"Python"}),L.jsxs("div",{className:"ide-layout",children:[L.jsxs("div",{className:"ide-left-panel",children:[L.jsx("div",{className:"ide-tabs",children:b.map(x=>L.jsx("button",{className:`ide-tab ${n===x.id?"active":""}`,onClick:()=>a(x.id),children:x.label},x.id))}),L.jsxs("div",{className:"ide-editor-container",children:[n==="matlab"&&t.matlabCode&&L.jsx("pre",{className:"ide-code-display",children:L.jsx("code",{children:t.matlabCode})}),n==="python"&&L.jsx("textarea",{className:"ide-code-editor",value:i,onChange:x=>l(x.target.value),spellCheck:!1,placeholder:"Write your Python code here..."})]}),t.params&&t.params.length>0&&L.jsxs("div",{className:"ide-params-section",children:[L.jsx("div",{className:"ide-params-header",children:"Parameters"}),L.jsx("div",{className:"ide-params-list",children:t.params.map(x=>L.jsxs("div",{className:"ide-param-input",children:[L.jsxs("label",{htmlFor:x.name,children:[x.label," ",x.unit&&`(${x.unit})`]}),L.jsx("input",{id:x.name,type:x.step===null?"text":"number",step:x.step||.01,value:h[x.name]!==void 0?h[x.name]:x.default,onChange:f=>y({...h,[x.name]:x.step===null?f.target.value:parseFloat(f.target.value)||x.default})})]},x.name))})]}),L.jsx("div",{className:"ide-actions",children:L.jsx("button",{onClick:T,disabled:o,className:"ide-run-button",children:o?"⏳ Running...":"▶ Run Program"})})]}),L.jsxs("div",{className:"ide-right-panel",children:[L.jsx("div",{className:"ide-results-header",children:L.jsx("span",{children:"📊 Output"})}),L.jsxs("div",{className:"ide-results-content",children:[s&&L.jsx(C1,{imageData:s}),m?L.jsx(N1,{text:m}):!s&&L.jsx("div",{className:"ide-no-output",children:'Click "Run Program" to see results here'})]})]})]})}function k1(){const[e,t]=I.useState(null),[n,a]=I.useState(!0),[i,l]=I.useState("正在加载 Python 环境...");return I.useEffect(()=>{async function o(){try{l("正在加载 Pyodide...（首次较慢，后续会缓存）");const r=document.createElement("script");r.src="https://cdn.jsdelivr.net/pyodide/v0.26.1/full/pyodide.js",r.async=!0,r.onload=async()=>{const s=await window.loadPyodide({indexURL:"https://cdn.jsdelivr.net/pyodide/v0.26.1/full/"});l("📦 正在加载 NumPy 和 Matplotlib..."),await s.loadPackage(["numpy","matplotlib"]),await s.runPythonAsync(`
import matplotlib
matplotlib.use('Agg')
...
import io
import base64
          `),t(s),a(!1),console.log("Pyodide loaded successfully")},document.body.appendChild(r)}catch(r){l("❌ 加载失败: "+r.message),console.error("Failed to load Pyodide:",r)}}o()},[]),n?L.jsx("div",{className:"app",children:L.jsxs("div",{style:{padding:"3rem",textAlign:"center"},children:[L.jsx("h1",{children:"Optics & Berkeley Extension Programs"}),L.jsx("p",{style:{color:"#6b7280",margin:"1rem 0"},children:"基于 React + Pyodide 的光学程序集"}),L.jsxs("div",{style:{fontSize:"1.2rem",color:"#9ca3af",marginTop:"2rem"},children:["⏳ ",i]})]})}):L.jsx("div",{className:"app",children:L.jsxs(h1,{children:[L.jsx(ja,{path:"/",element:L.jsx(P1,{})}),L.jsx(ja,{path:"/program/:programId",element:L.jsx(F1,{pyodide:e})}),L.jsx(ja,{path:"*",element:L.jsx(c1,{to:"/",replace:!0})})]})})}function F1({pyodide:e}){const{programId:t}=Qc(),n=wn.find(a=>a.id===t);return n?L.jsxs("div",{children:[L.jsxs("div",{className:"header",children:[L.jsx(ao,{to:"/",className:"back-link",children:"← 返回列表"}),L.jsx("h1",{children:n.title}),L.jsx("p",{className:"subtitle",children:n.description})]}),L.jsx(w1,{pyodide:e,program:n})]}):L.jsxs("div",{className:"error-page",children:[L.jsx("h1",{children:"程序未找到"}),L.jsx(ao,{to:"/",children:"返回首页"})]})}rl.createRoot(document.getElementById("root")).render(L.jsx(Rs.StrictMode,{children:L.jsx(v1,{children:L.jsx(k1,{})})}));
